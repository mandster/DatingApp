...
namespace DatingApp.Api.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        public async Task<Like> GetLiked(int userId, int likeeId)
        {
            return await _context.Likes.FirstOrDefaultAsync(u => u.LikerId == userId && u.LikeeId == likeeId);
        }
        ...
        public async Task<IEnumerable<Like>> UnLikeUser(int userId, int likeeId)
        {
            var user = await _context.Users.Include(x => x.Likers)
            .Include(x => x.Likees).FirstOrDefaultAsync(u => u.Id == userId);

            return user.Likees.Where(u => u.LikeeId == likeeId);
        }
        ...
        public Task<PageList<Message>> GetMessagesForUser(MessageParams messageParams)
        {
            ...
            return PageList<Message>.CreateAsync(messages, messageParams.PageNumber, messageParams.PageSize);
        }
